        ...
        <Tabs defaultValue="subscription" className="w-full">
          ...
          <ScrollArea className="h-[50vh] sm:h-[55vh]">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3 bg-primary/5 rounded-lg border border-primary/10">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    By subscribing, you agree that <span className="font-medium text-foreground">Websyncdigital</span> will charge your account monthly using Monnify Direct Debit.
                  </p>
                </div>
            ...
            <TabsContent value="terms" className="p-4 mt-0 space-y-4">
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Websyncdigital will design, host, and maintain your website for you.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    The website and all related assets remain the property of Websyncdigital. You are granted full access and usage rights to the website only while your subscription is active and paid.
                  </p>
                </div>
            ...
            <TabsContent value="privacy" className="p-4 mt-0 space-y-5">
              <p className="text-sm text-muted-foreground leading-relaxed">
                Websyncdigital is committed to protecting your personal information and ensuring your data is handled securely and responsibly.
              </p>
              ...
              <div className="space-y-2">
                ...
                <ul className="text-sm text-muted-foreground space-y-1 pl-6 list-disc">
                  <li>Creating your Websyncdigital account</li>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  All payment authorization is handled securely through Monnify (Moniepoint). Websyncdigital does not store your card, BVN, or bank login information.
                </p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Websyncdigital designs and hosts your website, but the website remains the property of Websyncdigital. You maintain full usage rights as long as your subscription remains active.
                </p>
              </div>
            </TabsContent>
          </ScrollArea>
